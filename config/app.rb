...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'lightning-picker.com'
  config.app_name = 'Lightning-picker'
  config.mailer.from = 'Lightning-picker <no-reply@lightning-picker.com>'
  ...
  #
  config.app_secret = 'FqmSYiR3B4qMn5C-UB-YNfJDAZGaXzodmgTwj0SkB5KcuaCLQe7qGmG5CwF-6rw8_uE'
